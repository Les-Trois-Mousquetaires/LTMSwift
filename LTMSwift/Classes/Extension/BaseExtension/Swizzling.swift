...
func ltmSwizzleMethod(_ forClass: AnyClass, originalSelector: Selector, swizzledSelector: Selector) {
...
public extension MethodSwizzling {
     ...
     */
    static func swizzlingForClass(_ forClass: AnyClass, originalSelector: Selector, swizzledSelector: Selector){
        ltmSwizzleMethod(forClass, originalSelector: originalSelector, swizzledSelector: swizzledSelector)
    }
}
