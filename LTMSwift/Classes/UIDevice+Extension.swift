    ...
    func isSimulator() -> Bool {
     ...
     var sizeModel: (size: String, model: String) {
        ...
        let deviceMap: [String: (size: String, model: String)] = [
            ...
            "iPhone3,2": ("3.5", "iPhone 4 GSM Rev A"),
            "iPhone3,3": ("3.5", "iPhone 4 CDMA"),
            "iPhone4,1": ("3.5", "iPhone 4S"),
            "iPhone5,1": ("4.0", "iPhone 5 (GSM)"),
            "iPhone5,2": ("4.0", "iPhone 5 (GSM+CDMA)"),
            "iPhone5,3": ("4.0", "iPhone 5C (GSM)"),
            "iPhone5,4": ("4.0", "iPhone 5C (Global)"),
            "iPhone6,1": ("4.0", "iPhone 5S (GSM)"),
            "iPhone6,2": ("4.0", "iPhone 5S (Global)"),
            "iPhone7,1": ("5.5", "iPhone 6 Plus"),
            "iPhone7,2": ("4.7", "iPhone 6"),
            "iPhone8,1": ("4.7", "iPhone 6s"),
            "iPhone8,2": ("5.5", "iPhone 6s Plus"),
            "iPhone8,4": ("4.0", "iPhone SE (GSM)"),
